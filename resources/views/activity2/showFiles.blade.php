...
<div class="card card-custom">
	<div class="card-header flex-wrap border-0 pt-6 pb-0">
		...
		<div class="card-toolbar">
			...
			<!--begin::Button-->
			<a href="{{route('files.files.create')}}" class="btn btn-primary font-weight-bolder">
				...
				<thead class="datatable-head">
					<tr class="datatable-row" style="left: 0px;">
						...
						<th data-field="OrderID" class="datatable-cell datatable-cell-sort">
							<span style="width: 108px;">File Name</span>
						</th>

						<th data-field="Country" class="datatable-cell datatable-cell-sort">
							<span style="width: 108px;">File Type</span>
						</th>
				...
				<tbody class="datatable-body" style="">
						...
						<tr data-row="0" class="datatable-row" style="left: 0px;">
							...
							<td data-field="Country" aria-label="China" class="datatable-cell">
								<span style="width: 108px;">{{$file->file_name}}</span>
							</td>

                            <td data-field="CompanyName" aria-label="Kris-Wehner" class="datatable-cell">
								<span style="width: 108px;">{{$file->file_type}}</span>
							</td>

							<td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell">
								<span style="width: 108px;">{{$file->created_at}}</span>
							</td>

							<td data-field="CompanyName" aria-label="Kris-Wehner" class="datatable-cell">
								<span style="width: 108px;">{{$file->updated_at}}</span>
							</td>
							...
							<td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
								<span style="overflow: visible; position: relative; width: 125px;">						
									<form id="delete" action="{{route('files.files.destroy', $file->id)}}" method="POST">
										...
										<a href="{{route('files.files.show', $file)}}" class="btn btn-sm btn-clean btn-icon mr-2"">						
											<span class="svg-icon svg-icon-md">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"></rect>	                            
										...
										<a href="{{route('files.files.edit', $file)}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
											<span class="svg-icon svg-icon-md">	                                
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"></rect>
