...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="sidebar-heading">Web Software Tools 2 </div>
        <div class="list-group list-group-flush">
            <a href="/products" class="list-group-item list-group-item-action bg-light">Activity 1</a>
            <a href="/files" class="list-group-item list-group-item-action bg-light">Activity 2 - Uploading</a>
