										...
										<ul class="menu-subnav">
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="/products" class="menu-link menu-toggle">
													...
													<span class="menu-text">Activity 1</span>
												</a>
											</li>
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="/files" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">Activity 2 - Uploading</span>
												</a>
												...
												<a href="#" class="menu-link menu-toggle">
													...
													<span class="menu-text">Activity 3</span>
												</a>
											</li><li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="#" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
													...
													<span class="menu-text">Activity 4</span>
												</a>
											</li><li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="#" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
													...
													<span class="menu-text">Activity 5</span>
												</a>
											</li><li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="#" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-line">
													...
													<span class="menu-text">Activity 6</span>
												</a>
											</li>
										</ul>
									</div>
