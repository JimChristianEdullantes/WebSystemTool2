...
<div class="card card-custom">
	<div class="card-header flex-wrap border-0 pt-6 pb-0">
		...
		<div class="card-toolbar">
			...
			<!--begin::Button-->
			<a href="{{route('products.products.index')}}" class="btn btn-primary font-weight-bolder">
				...
				<tbody class="datatable-body" style="">
						...
						<tr data-row="0" class="datatable-row" style="left: 0px;">
							...
							<td data-field="Country" aria-label="China" class="datatable-cell">
								<span style="width: 108px;">{{$product->id}}</span>
							</td>
							...
							<td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
								<span style="width: 108px;"><span class="label label-primary label-dot mr-2"></span>
									<span class="font-weight-bold text-primary">{{$product->created_at}}</span>
								</span>
							</td>
							...
							<td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
								<span style="overflow: visible; position: relative; width: 125px;">						
									<form id="delete" action="{{route('products.products.destroy', $product)}}" method="POST">
										...
										<a href="{{route('products.products.show', $product)}}" class="btn btn-sm btn-clean btn-icon mr-2"">						
											<span class="svg-icon svg-icon-md">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"></rect>	                            
										...
										<a href="{{route('products.products.edit', $product)}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
											<span class="svg-icon svg-icon-md">	                                
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"></rect>
